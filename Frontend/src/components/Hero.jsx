...
const Hero = () => {
  return (
    <section className="w-full max-w-[90%] mx-auto mt-28 md:mt-36 lg:mt-40">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-50 via-white to-indigo-50 min-h-[650px] lg:min-h-[605px]">
        {/* Decorative Circles */}
        <div className="absolute -top-24 -right-24 h-80 w-80 rounded-full bg-blue-100 opacity-40"></div>

        <div className="absolute bottom-0 right-20 md:right-32 h-44 w-44 md:h-56 md:w-56 rounded-full bg-indigo-100 opacity-30"></div>

        <div className="absolute top-10 left-1/2 h-24 w-24 md:h-32 md:w-32 rounded-full bg-sky-100 opacity-40"></div>

        <div className="grid lg:grid-cols-2 items-center gap-12 px-6 sm:px-8 md:px-12 lg:px-16 py-12 md:py-16">
          {/* Left Content */}
          <div className="text-center lg:text-left">
            ...
            <h1 className="mt-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Find Everything
              <br />
              You Need
            </h1>

            <p className="mt-5 text-base md:text-lg text-gray-600 leading-7 md:leading-8 max-w-xl mx-auto lg:mx-0">
